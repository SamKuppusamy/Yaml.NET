...
namespace SMC.Yaml
{
    public class YamlTagCollection : ICollection< YamlTag >, IDictionary< string, YamlTag >
    {
        ...
        #region ICollection<YamlTag> Members
        ...
        #region IDictionary<string,YamlTag> Members
        ...
        {
            return _tagByVerbatimDictionary.Remove( item.VerbatimTag ) &&
                   _tagByAbbreviatedDictionary.Remove( item.AbbreviatedTag );
        }
        ...
        /// </returns>
        bool ICollection< KeyValuePair< String, YamlTag > >.IsReadOnly
        {
            get { return true; }
        }
        ...
        public YamlTag this[ string key ]
        {
            get
            {
                return _tagByVerbatimDictionary.ContainsKey( key )
                           ? _tagByVerbatimDictionary[ key ]
                           : _tagByAbbreviatedDictionary[ key ];
            }
            [ TerminatesProgram ]
