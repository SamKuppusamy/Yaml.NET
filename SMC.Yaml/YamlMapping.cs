...
namespace SMC.Yaml
{
    public class YamlMapping : YamlNode, IDictionary<YamlScalar, YamlNode>
    {
        private readonly Dictionary<YamlScalar, YamlNode> _internalDictionary = new Dictionary<YamlScalar, YamlNode>();
        ...
        public IEnumerator<KeyValuePair<YamlScalar, YamlNode>> GetEnumerator()
        {
        ...
        ///                 </exception>
        public void Add(KeyValuePair<YamlScalar, YamlNode> item)
        {
            ((ICollection<KeyValuePair<YamlScalar, YamlNode>>)_internalDictionary).Add(item);
        }
        ...
        ///                 </param>
        public bool Contains(KeyValuePair<YamlScalar, YamlNode> item)
        {
            return ((ICollection<KeyValuePair<YamlScalar, YamlNode>>) _internalDictionary).Contains(item);
        }
        ...
        ///                 </exception>
        public void CopyTo(KeyValuePair<YamlScalar, YamlNode>[] array, int arrayIndex)
        {
            ((ICollection<KeyValuePair<YamlScalar, YamlNode>>) _internalDictionary).CopyTo(array, arrayIndex);
        }
        ...
        ///                 </param><exception cref="T:System.NotSupportedException">The <see cref="T:System.Collections.Generic.ICollection`1"/> is read-only.
        ///                 </exception>
        public bool Remove(KeyValuePair<YamlScalar, YamlNode> item)
        {
            ((ICollection<KeyValuePair<YamlScalar, YamlNode>>) _internalDictionary).Remove(item);
        }
        ...
        ///                 </exception>
        public void Add(YamlScalar key, YamlNode value)
        {
        ...
        ///                 </param><exception cref="T:System.ArgumentNullException"><paramref name="key"/> is null.
        ///                 </exception>
        public bool TryGetValue(YamlScalar key, out YamlNode value)
        {
        ...
        ///                 </exception>
        public YamlNode this[YamlScalar key]
        {
